{{-- <x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <textarea id="about" name="about" class="block mt-1 w-full" rows="3">{{ old('about') }}</textarea>
...
<head>
    ...
    <style>
        ...
        .form-control:focus {
            border-color: #007bff;
            box-shadow: 0 0 0 .2rem rgba(38, 143, 255, 0.25);
        }
                ...
                <div class="form-container">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="phone_number" type="tel" name="phone_number" required class="form-control">
                            @error('phone_number')
                                <span class="error-message">{{ $message }}</span>
                            @enderror
                        </div>
