    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="fixed top-0 right-0 p-6 text-right z-10">
                @auth
                    <a href="{{ url('/dashboard') }}" class="btn btn-secondary-custom">Dashboard</a>
                @else
                    <div class="button-container">
                        <a href="{{ route('login') }}" class="btn btn-link-custom me-4">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn btn-link-custom">Register</a>
                        @endif
                    </div>
                @endauth
            </div>
            ...
            <div id="carouselExampleCaptions" class="carousel slide">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ asset('storage/images/arnel-hasanovic-MNd-Rka1o0Q-unsplash.jpg') }}"
                            class="d-block w-100" alt="Slide 1">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="hero-title">Welcome to My Blogs</h5>
                            <p class="hero-subtitle">Explore the latest articles and updates from our community.</p>
                            <a href="{{ route('login') }}" class="btn btn-custom mt-4">Read Latest Posts</a>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('storage/images/glenn-carstens-peters-npxXWgQ33ZQ-unsplash.jpg') }}"
                            class="d-block w-100" alt="Slide 2">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="hero-title">Welcome to My Blogs</h5>
                            <p class="hero-subtitle">Discover articles on the latest trends and tips in our first
                                feature.</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('storage/images/patrick-tomasso-Oaqk7qqNh_c-unsplash.jpg') }}"
                            class="d-block w-100" alt="Slide 3">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="hero-title">Welcome to My Blogs</h5>
                            <p class="hero-subtitle">Read in-depth articles and tutorials on various topics in our
                                second feature.</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('storage/images/unseen-studio-s9CC2SKySJM-unsplash.jpg') }}"
                            class="d-block w-100" alt="Slide 4">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="hero-title">Welcome to My Blogs</h5>
                            <p class="hero-subtitle">Explore our curated content and updates on the latest happenings in
                                our third feature.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    <div class="card feature-card mb-4">
                        <img src="{{ asset('storage/images/jess-bailey-y7GlIdTUOvo-unsplash.jpg') }}"
                            class="card-img-top" alt="Feature 1">
                        <div class="card-body">
                            <h5 class="card-title">Feature 1</h5>
                            <p class="card-text">Discover articles on the latest trends and tips in our first feature.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card feature-card mb-4">
                        <img src="{{ asset('storage/images/pexels-pixabay-262508.jpg') }}" class="card-img-top"
                            alt="Feature 2">
                        <div class="card-body">
                            <h5 class="card-title">Feature 2</h5>
                            <p class="card-text">Read in-depth articles and tutorials on various topics in our second
                                feature.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card feature-card mb-4">
                        <img src="{{ asset('storage/images/pexels-suzyhazelwood-3631711.jpg') }}" class="card-img-top"
                            alt="Feature 3">
                        <div class="card-body">
                            <h5 class="card-title">Feature 3</h5>
                            <p class="card-text">Explore our curated content and updates on the latest happenings in our
                                third feature.</p>
                        </div>
                    </div>
                </div>
